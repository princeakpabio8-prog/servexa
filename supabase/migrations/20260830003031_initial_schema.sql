-- SERVEX initial database schema
-- Core workflow:
-- Customer -> Campaign -> Call -> Outcome -> Follow-up -> Activity
...
create table if not exists public.calls (
  ...
  status text not null default 'queued'
    check (status in ('queued','initiated','ringing','in_progress','completed','failed','cancelled')),
