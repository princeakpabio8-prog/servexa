...
const attention = [
  { name: 'Sarah Johnson', reason: 'Payment issue reported', priority: 'High' },
  { name: 'David Smith', reason: 'Amount disputed', priority: 'High' },
  { name: 'Amaka Williams', reason: 'Requested a human agent', priority: 'Medium' },
];

const activity = [
  { name: 'Sarah Johnson', detail: 'Payment reminder', result: 'Promise to pay', time: '2 min ago', type: 'follow' },
  { name: 'Michael Brown', detail: 'Loan repayment', result: 'Resolved', time: '18 min ago', type: 'resolved' },
  { name: 'David Smith', detail: 'Document collection', result: 'Human attention', time: '34 min ago', type: 'attention' },
];
