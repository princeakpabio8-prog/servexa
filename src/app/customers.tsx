...
// Map of fictional demo customer IDs to non-production example identifiers.
const CUSTOMER_UUID_MAP: { [key: string]: string } = {
  '2': 'example-customer-id',
};
...
const seedCustomers: Customer[] = [
  {
    ...
    phone: '+12025550100',
    reason: 'Sample payment question',
  ...
  },
  {
    ...
    phone: '+12025550100',
    reason: 'Sample document question',
    amount: '—',
  ...
  },
  {
    ...
    phone: '+12025550100',
    reason: 'Sample renewal reminder',
    amount: 'Sample amount',
  ...
  },
  {
    id: '6',
    initials: 'EC',
    name: 'Example Customer 06',
    phone: '+12025550100',
    reason: 'Sample customer follow-up',
    amount: '—',
...
export default function CustomersScreen() {
  ...
  const [manualPhone, setManualPhone] = useState('+12025550100');
